/*
  ...
  - Added the required column `picture_url` to the `cham` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_cham" ("id", "is_favorite", "name", "style_id", "user_id") SELECT "id", "is_favorite", "name", "style_id", "user_id" FROM "cham";
DROP TABLE "cham";
